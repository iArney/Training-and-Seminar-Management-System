<template>
  <div>
    <v-app-bar flat class="appbr pt-2">
         <v-img
        ...
        max-height="70"
      />
      <h3 class="logo-text d-inline-block deep--text fw-bold">TSMS</h3>
         <v-spacer></v-spacer>
         <span>12:30</span>
         <span class="ms-3">Mon, 21 Feb</span>
          <v-avatar size="45" class="ms-3">
            <img src="@/assets/images/lisa.webp" alt="userprofile" />
          </v-avatar>
    </v-app-bar>
    <v-container id="Banner" class="position-relative vh-100 pt-10" fluid>
      <v-row no-gutters>
                  ...
                  <v-row>
                    <v-col class="d-flex justify-center">
                      <v-btn
                        ...
                        large
                        color="deep"
                        class="zoom white--text text-capitalize text-right"
                        ><v-icon color="white">
