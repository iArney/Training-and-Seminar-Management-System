    ...
    <v-main class="light">
      <v-container fluid>
        <v-row class="mt-14 mx-md-6">
          <v-col cols="12" md="5" class="py-12" lg="3">
            <v-card height="750" class="align-center py-12">
              <v-img
                ...
                <v-row no-gutters>
                  <v-col cols="6">
                    <div class="d-flex flex-row">
                      ...
                      <span class="ms-2">10 Training attended</span>
                    </div>
                  </v-col>
                  <v-col cols="6">
                    <div class="d-flex flex-row">
                      ...
                      <span class="ms-2">0 Training Requested</span>
                    </div>
                  </v-col>
                </v-row>
              </v-container>
          ...
          <v-col cols="12" md="7" lg="9">
            ...
            <v-card class="mb-12 ps-8">
              ...
              <div class="py-10">
                <div
                  class="border-start position-relative px-6"
                ...
                >
                  ...
                  <span class="float-right">12 min ago</span>
                </div>
                <div
                  class="border-start position-relative px-6"
                  style="min-height: 100px"
              ...
              <!-- <div class="line"></div>
              <div class="badge">
                <v-badge bordered overlap dot color="blue" class="mt-16">
                </v-badge>
              </div>
              <div class="line-1"></div>
              <div class="badge">
                <v-badge bordered overlap dot color="green" class="mt-16">
                </v-badge>
              </div>
